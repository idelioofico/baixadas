...
<html lang="pt-pt">
    ...
    <head>
        <meta charset="utf-8">
        <title>ENTRADAS DIARIA DE Material das BAIXADAS - {{ ($site_data) }}</title>
        ...
        <div id="container">
            ...
            <div style="position: relative">
                ...
                <section id="invoice-title-number">
                    ...
                    <span id="title">ENTRADA diária de Material - {{ ($site_data) }}</span>
            ...
            <section id="items" >
                ...
                <table  class="table table-hover table-dashed table-striped table-bordered" >
                    <thead class="thead-default">
                        <tr>
                            <th colspan="14" style="color: black; text-align: center; padding: 12px">Materiais e Acessórios Recebidos</th>
                        </tr>
                    </thead>
                    <thead class="thead-default" >
                        <tr>
                            <th colspan="3" style="padding-bottom: 6px; color: black; text-align: center; background: darkgray"></th> 
                    ...
                    <thead class="thead-default" >
                        <tr>
                            <th style="text-align: center; padding-bottom 5px: 12px; font-size: 10px; color: black; background: burlywood; width: 10%">
                                Projecto | Site
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr> 
                            <td colspan="3" style="padding: 12px; text-align:right; font-weight: 900; font-size: 12px; background: darkgray">{{ $quadrelec }} &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td> 
