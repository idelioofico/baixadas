        ...
        <div id="container">
            ...
            <div style="position: relative">
                ...
                <section id="invoice-title-number">
                    ...
                    <span id="title">Execução diária de Material - {{ ($site_data) }}</span>
            ...
            <section id="items" >
                ...
                <table  class="table table-hover table-dashed table-striped table-bordered" >
                    <thead class="thead-default">
                        <tr>
                            <th colspan="14" style="color: black; text-align: center; padding: 12px">Materiais e Acessórios Fornecidos</th>
                        </tr>
                    </thead>
                    <thead class="thead-default" >
                        <tr>
