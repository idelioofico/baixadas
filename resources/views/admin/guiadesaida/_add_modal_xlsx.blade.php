...
<div class="modal fade" id="exporXlsxModal" tabindex="-1" role="dialog" aria-labelledby="exporXlsxModalLabel" aria-hidden="true">
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('import_xls.baixada') }}" enctype="multipart/form-data" method="POST">
                    @method('POST')
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="date" name="data" value="{{ date('Y-m-d') }}" class="form-control br">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <input type="text" name="lote" placeholder="Ex: Lote IV" class="form-control br">
                                <p class="text-danger">{{ $errors->first('lote') }}</p>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <label for="">Ficheiro</label>
                            <div class="form-group">
                                <input type="file" required name="import_file" class="form-control br">
